...
border: 2px solid black;background-color:rgb(152, 116, 112);color:#f2f2f2;font-size:17px;">
    Back</button>
</form>
<form method="post" action="dogsadd.php" >  
<fieldset>
 ...
 <input type="number" step=any name="height"  placeholder="Enter height" style="width:300px;height:30px;
  ...
  <br><br>
  <input type="submit" name="submit" value="save" style="width:100%;height:34px;
...
INSERT INTO dogs(pet_id,weight,height,age,fur)
 VALUES('$id','$weight','$height','$age','$fur')";
